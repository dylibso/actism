 ...
 */
export declare class PluginOutput extends DataView {
    #private;
    /** @hidden */
 ...
 *
 */
export type ManifestWasm = (ManifestWasmUrl | ManifestWasmData | ManifestWasmPath | ManifestWasmResponse | ManifestWasmModule) & {
    name?: string;
    hash?: string;
};
/**
