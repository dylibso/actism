...
export type { Capabilities, ExtismPluginOptions, ManifestLike, ManifestWasmResponse, ManifestWasmModule, ManifestWasmData, ManifestWasmUrl, ManifestWasmPath, ManifestWasm, Manifest, Plugin, PluginOutput, } from './interfaces.ts';
