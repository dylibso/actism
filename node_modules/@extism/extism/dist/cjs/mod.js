...
// src/manifest.ts
var import_node_fs = require("node:fs/promises");
...
async function createForegroundPlugin(opts, names, modules, context = new CallContext(ArrayBuffer, opts.logger, opts.config)) {
  ...
  const instances = await Promise.all(
    modules.map(async (module2) => {
      ...
      initRuntime();
      return { module: module2, instance, guestType };
    })
  );
